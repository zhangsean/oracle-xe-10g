...
RUN dpkg --add-architecture i386 && \
    ...
    echo 'export NLS_LANG="SIMPLIFIED CHINESE_CHINA.AL32UTF8"' >> /etc/bash.bashrc && \
    echo 'export ORACLE_SID=XE' >> /etc/bash.bashrc && \
    wget 10.0.1.136/oracle-xe_10.2.0.1-1.1_i386.debaa && \
    wget 10.0.1.136/oracle-xe_10.2.0.1-1.1_i386.debab && \
    wget 10.0.1.136/oracle-xe_10.2.0.1-1.1_i386.debac && \
